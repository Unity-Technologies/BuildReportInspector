...
* There is now a built-in Build Analysis Window (Windows -> Analysis -> Build Analysis) which shows information similar to the Build Report Inspector.  So in many cases it is not necessary to install this package anymore (but it continues to function).
